                        ...
                        <div class="form-row">
                            <div class="form-group col-12">
                                <div class="custom-control custom-checkbox">
                                    ...
                                    <label class="custom-control-label" for="checkBoxChangePassword">{{ __('kuber::admin/profile/index.checkBoxChangePassword') }}</label>
                                </div>
                            </div>
                            <div class="form-row col-12 d-none" id="changePassword">
                                <div class="form-group col-md-6">
                                    <label for="password">{{ __('kuber::admin/profile/index.password') }}</label>
                                    <input type="password" class="form-control" id="password" name="password">
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="password_confirmation">{{ __('kuber::admin/profile/index.password_confirmation') }}</label>
